  ...
  .then(data => {
    ...
    if (productos === null) {
      ...
      var contenidoDivBotones = `
            <form method="post" action="../../../BackEnd/gestion/vaciarCarrito.php">
              <button type="submit" class="btn btn-outline-dark border border-secondary rounded" name="vaciar_carrito">
